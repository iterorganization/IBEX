...
class PlotDataRequestModel(BaseModel):
    ...
    interpolate_over: Optional[List[str]] = Field(default=None, description="List of IMAS URIs to be used in data interpolation")
    ...
    smoothing_sigma: float | None = Field(default=None, description="Parameter used in Gaussian smoothing algorithm. See https://docs.scipy.org/doc/scipy/reference/generated/scipy.ndimage.gaussian_filter.html.")
