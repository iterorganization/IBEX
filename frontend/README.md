...
Pin the version: an unversioned `module load nodejs` follows the cluster default, which moved from
Node 20 to Node 22 with the 2025b toolchain on 2025-07-31.
